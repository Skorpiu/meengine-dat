...
- **Signup hardening plan** — phased invite-only, verification, and distributed rate limits (docs only until implementation batches ship): [signup-hardening-plan.md](./driving_school_platform/nextjs_space/docs/engineering/signup-hardening-plan.md).
