...
export const FEATURE_DEFINITIONS: Record<FeatureKey, FeatureDefinition> = {
  STUDENT_ACCESS: {
    ...
    description:
      "Allow students to log in and view their lessons, progress, and schedule",
    category: "PREMIUM",
    icon: "👨‍🎓",
  },
  VEHICLE_MANAGEMENT: {
    ...
    description:
      "Manage vehicles, maintenance schedules, and vehicle assignments",
    category: "PREMIUM",
    icon: "🚗",
  },
  LESSON_MANAGEMENT: {
    ...
    description:
      "View and track recent and upcoming lessons across all categories",
    category: "PREMIUM",
    icon: "📚",
  },
  SCREENSHOT_PROTECTION: {
