...
export function LessonForm({
  ...
  const [instructorId, setInstructorId] = useState<string>(
    instructorUserId || initialLesson?.instructorId || ''
  );
  const [studentId, setStudentId] = useState<string>(
    initialLesson?.studentId ? String(initialLesson.studentId) : ''
  );
  ...
  useEffect(() => {
    if (mode === 'edit' && initialLesson) {
      ...
      setInstructorId(initialLesson.instructorId || '');
      setStudentId(initialLesson.studentId ? String(initialLesson.studentId) : '');
