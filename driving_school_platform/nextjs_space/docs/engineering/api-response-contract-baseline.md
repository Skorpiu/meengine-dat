...
| `/api/admin/invitations`             | POST                   | `{ invitation, inviteLink }` (201)                                                         | `{ error, code }` e.g. `pending_invitation_exists`, `user_already_exists` (409) | No                                     | `inviteLink` only on create; no link when user email already exists                 | P3                                                    |
