...
| **Demo UX polish**                                | Lesson/exam booking on admin and instructor dashboards triggers an explicit Schedule Map refetch (and calendar focus on booked date) without a full page reload (`lesson-create-refresh-ui`).                                                                                                        |
