...
| EEA-005 | P2       | Modularity       | Vehicles (and similar) use `getServerSession` + bespoke JSON instead of `verifyAuth` / `withErrorHandling`.                                                                                                                                                                                                           | `app/api/admin/vehicles/route.ts`                                              | See [route-handler-consistency-audit.md](./route-handler-consistency-audit.md) — **vehicles-route-handler-alignment** batch. |
