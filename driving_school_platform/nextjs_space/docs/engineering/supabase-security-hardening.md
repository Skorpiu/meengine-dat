...
| **B2 tenant business**  | `students`, `instructors`, `vehicles`, `lessons`, `exams`, `lesson_requests`, `lesson_counters`, `exam_registrations`, `payments`, `notifications`, `organizations`, `organization_features` | **Done (migration in repo)** — [`20260610160000_supabase_rls_class_b_hardening_v1b_tenant_business_revoke`](../../prisma/migrations/20260610160000_supabase_rls_class_b_hardening_v1b_tenant_business_revoke/migration.sql); operator deploy human-controlled |
