...
| **B3 global reference** | `categories`, `transmission_types`, `user_preferences`                                                                                                                                       | **Done (migration in repo)** — [`20260610170000_supabase_rls_class_b_hardening_v1b_global_reference`](../../prisma/migrations/20260610170000_supabase_rls_class_b_hardening_v1b_global_reference/migration.sql); operator deploy human-controlled; **v1b complete (31/31)** |
