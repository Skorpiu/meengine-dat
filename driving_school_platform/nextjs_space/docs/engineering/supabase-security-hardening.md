...
| **B2 tenant business**  | `students`, `instructors`, `vehicles`, `lessons`, `exams`, `lesson_requests`, `lesson_counters`, `exam_registrations`, `payments`, `notifications`, `organizations`, `organization_features` | **Done + deployed + smoke-passed** (2026-06-10, main `dd26d18`) — [`20260610160000_supabase_rls_class_b_hardening_v1b_tenant_business_revoke`](../../prisma/migrations/20260610160000_supabase_rls_class_b_hardening_v1b_tenant_business_revoke/migration.sql)                           |
| **B3 global reference** | `categories`, `transmission_types`, `user_preferences`                                                                                                                                       | **Done + deployed + smoke-passed** (2026-06-10, main `cdfacf2`) — [`20260610170000_supabase_rls_class_b_hardening_v1b_global_reference`](../../prisma/migrations/20260610170000_supabase_rls_class_b_hardening_v1b_global_reference/migration.sql); **v1b revoke-only complete (31/31)** |
