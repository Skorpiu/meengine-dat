...
| Slice                   | Tables                                                                                                                                                                                       | Status                                                                                                                                                                                                        |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **B1 nextauth**         | `accounts`, `sessions`, `verification_tokens`, `users`                                                                                                                                       | **Done** — [`20260610150000_supabase_rls_class_b_hardening_v1b_nextauth`](../../prisma/migrations/20260610150000_supabase_rls_class_b_hardening_v1b_nextauth/migration.sql); operator deploy human-controlled |
