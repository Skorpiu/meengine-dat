...
| **Engineering excellence audit**                     | **Started:** initial audit doc created — [engineering-excellence-audit.md](../engineering/engineering-excellence-audit.md) (architecture, data-access risks, security boundaries, tests, DX/CI). **Still open:** role matrix automation, hostile-input passes, optional rate limits on public forms, response-shape review under production, expanded Playwright or scripted checks beyond the documented baseline. |
