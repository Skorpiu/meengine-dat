...
| **Basic / Premium / Full demo organizations**        | Productized tiers of demo experience (depth of modules, personas) are **not** fully modeled yet; portfolio doc recommends starting with **Full Showcase Demo only** when depth is needed ([public-portfolio-access.md](./public-portfolio-access.md)). |
...
2. **Demo org tiers** — Basic / Premium / Full showcase orgs as a productized story once isolation and reset are trustworthy.
