...
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| `PLATFORM_HOSTS`                                                           | Comma-separated hosts for platform routing (`lib/tenant.ts` default if unset). |
...
| `PLATFORM_ADMIN_EMAIL`, `PLATFORM_ADMIN_PASSWORD`, etc.                    | `scripts/create-platform-admin.ts`.                                            |
