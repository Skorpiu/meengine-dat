        ...
        <div className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              {t.landing.title.split(" ")[0]} Driving School Academy
            </h1>
        ...
        <Card className="shadow-lg border-0 hover-card">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="drivingSchool">
                  {t.register.drivingSchool}
                </Label>
                <Select
                  value={formData.drivingSchoolId}
                  onValueChange={(value) =>
                    handleInputChange("drivingSchoolId", value)
                  }
                >
                  <SelectTrigger className="h-11">
                ...
                <div className="space-y-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger className="h-11">
                        <SelectValue
                          placeholder={t.register.selectTransmissionType}
                        />
                      </SelectTrigger>
                      <SelectContent>
              ...
              {formData.role === "INSTRUCTOR" && (
                <div className="space-y-4 p-4 bg-green-50 rounded-lg">
                  <h3 className="font-medium text-green-900">
                    {t.register.instructorInformation}
                  </h3>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="instructorLicenseNumber">
                        {t.register.instructorLicenseNumber}
                      </Label>
                      <Input
                        ...
                        onChange={(e) =>
                          setInstructorLicenseNumber(e.target.value)
                        }
                        required
                        className="h-11"
                      />
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="instructorLicenseExpiry">
                        {t.register.licenseExpiryDate}
                      </Label>
                      <Input
                        ...
                        onChange={(e) =>
                          setInstructorLicenseExpiry(e.target.value)
                        }
                        required
                        className="h-11"
                      />
              ...
              <div className="flex items-start space-x-2">
                ...
                <Label htmlFor="terms" className="text-sm leading-normal">
                  ...
                  <Link
                    href="#"
                    className="text-driving-primary hover:underline"
                  >
