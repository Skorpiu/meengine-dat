...
export default async function InstructorDashboard() {
  ...
  const instructor = {
    ...
    averageRating: instructorRaw.averageRating
      ? Number(instructorRaw.averageRating)
      : 0,
    passRatePercentage: instructorRaw.passRatePercentage
      ? Number(instructorRaw.passRatePercentage)
      : 0,
  };
  ...
  const [completedLessonsThisMonth, pendingRequests] = stats;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Welcome back, {session.user.firstName}! Here&apos;s your teaching
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-green-600">
                    {instructor.passRatePercentage.toFixed(1)}%
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Total Lessons</span>
                  <span className="font-semibold">
                    {instructor.totalLessonsCompleted}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {instructor.hireDate
                      ? Math.floor(
                          (Date.now() -
                            new Date(instructor.hireDate).getTime()) /
                            (1000 * 60 * 60 * 24 * 365),
                        )
                      : 0}{" "}
                    years
