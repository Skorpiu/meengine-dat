...
**Status:** Foundation implemented in `audit-log-write-paths-foundation-v1`; invitation create/revoke wired in `audit-log-write-paths-integration-v1`; instructor qualified categories + deactivate wired in `audit-log-write-paths-people-v1`; lesson create + update wired in `audit-log-write-paths-lessons-v1`; student app-access remove + reactivate wired in `audit-log-write-paths-students-v1`.
