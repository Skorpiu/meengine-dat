...
| Slice | Notes |
| ----- | ----- |
| Audit log runtime implementation | **16 actions wired** — see [audit-log-coverage-readiness-review.md](./audit-log-coverage-readiness-review.md); next P1: `instructor.email.change` |
