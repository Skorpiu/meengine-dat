...
| Slice | Notes |
| ----- | ----- |
| Audit log runtime implementation | **13 actions wired** — see [audit-log-coverage-readiness-review.md](./audit-log-coverage-readiness-review.md); next P1: `invitation.email.change`, `instructor.reactivate` |
