...
| Slice | Notes |
| ----- | ----- |
| Audit log runtime implementation | **14 actions wired** — see [audit-log-coverage-readiness-review.md](./audit-log-coverage-readiness-review.md); next P1: `instructor.reactivate`, `instructor.delete` |
