...
- **People polish (split / deferred):** `people-management-record-status-badges-v1`, `people-management-row-app-access-v1`, `people-management-app-accounts-demote-v1`, `instructor-people-search-v1`, `instructor-records-export-v1`, `instructor-records-import-dry-run-v1`, `instructor-delete-policy-v1`, `cleanup-test-people-dry-run-v1` — see parent note `people-management-records-polish-v1` (analysis only).
