...
- **People polish (split / deferred):** `people-management-edit-instructor-unified-v1`, `people-management-app-accounts-demote-v1`, `people-management-app-access-lifecycle-policy-v1` (remove/deactivate + reactivate app access; preserve profile/history; reuse profile on re-enrollment — may extend unlink policy), `people-management-student-email-change-policy-v1` (canonical Change email flow), `people-management-app-account-unlink-policy-v1`, `people-management-onboarding-unlinked-invitations-v1`, `people-management-instructor-profile-invite-badge-v1`, `instructor-records-list-api-v1`, `admin-users-page-tenant-scope-v1`, `instructor-records-export-v1`, `instructor-records-import-dry-run-v1`, `instructor-delete-policy-v1`, `cleanup-test-people-dry-run-v1` — see parent note `people-management-records-polish-v1` (analysis only). **Absorbed/done:** `people-management-record-status-badges-v1`, `instructor-people-search-v1`.
