...
- **Next gated slice (recommended):** `invitation-email-update-linked-student-v1` (runtime) or `tenant-operational-organization-id-not-null-migrations` (D4) per priority.
