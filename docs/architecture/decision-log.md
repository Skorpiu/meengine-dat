...
| 2026-06-03 | DEC-003 | **People UX:** prefer internal tabs on `/admin/users` before route split; target Students/Invitations, Instructors/Invitations, App accounts. `/admin/instructors` route split deferred (D4). | Accepted | `product-roadmap-and-platform-boundary-sync-v1` | Next slice: `people-management-internal-tabs-v1`; defer `people-management-ux-unification-instructor-route-split-v1` |
