...
- **Live remediation (2026-08-20):** **IMPLEMENTATION COMMITTED / NOT YET SOURCE-PUBLISHED** (DEC-069; architect EQR B1 **CLOSED**; architect v2 EQR **PASS**). Canonical operator path `pnpm ops:migrate-deploy-remote`. DIRECT_URL host is bound to independent `DAT_OPS_EXPECTED_DIRECT_DB_HOST`. Recovery **COMMITTED + SOURCE BRANCH PUBLISHED** at `47a101b261a2fab144d73469e699389fc94ceb1c`. Implementation commit `10093da1068f6d08caf0bb5f83c6810429dd61d7`. At this pre-publication checkpoint, `origin/migration-deploy-target-safety-gate-v1` still equals recovery `47a101b261a2fab144d73469e699389fc94ceb1c`. Resolve live remote state through Git after publication. Merge SHA **none**. No migration executed.
