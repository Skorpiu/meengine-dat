...
- **Live remediation (2026-08-24):** **REVALIDATION IN PROGRESS** against current-main baseline `14b07dfc2ece5100dfee9b5f1c56f9ee0ab09ebe` (DEC-069; published source tip before this reconciliation `ec39e05d2ffda40f439f3bdadc7889853e5ca9ef`; architect EQR B1 **CLOSED**; architect v2 EQR **PASS** historically in-branch). Canonical operator path `pnpm ops:migrate-deploy-remote`. DIRECT_URL host is bound to independent `DAT_OPS_EXPECTED_DIRECT_DB_HOST`. Distinct durable anchors: recovery `47a101b261a2fab144d73469e699389fc94ceb1c`; implementation `10093da1068f6d08caf0bb5f83c6810429dd61d7`; post-implementation continuity/source-publication anchor `6d178bc3479668448809ee861c54fa3a0074cb46`. Merge SHA **none**. Historical targeted validation 6 files / 102 tests PASS and source-publication canonical validation with process-local fake loopback URLs are **not** the current-main revalidation result. No migration executed. Do not claim revalidation PASS, merge-ready, or Solution #4 CLOSED ON MAIN. Lifecycle after this prospective reconciliation: semantic-resolution EQR → validation → human-controlled publication/integration gates. Merge is not authorized. This is not migration-execution authorization.
