...
| **Node.js runtime** | Migration to **Node 24** is active in `node-24-runtime-migration-v1`: the local compatibility probe passed on Node 24.18.0; repository and CI pins are updated; pipeline and Vercel deployment verification remain pending. |
