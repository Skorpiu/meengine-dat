...
1. `admin-settings-client-visibility-hide-v1` — UI-only: remove Settings from school admin navbar; operator message on `/admin/settings`; APIs unchanged (product P1)
