...
1. `people-management-instructor-profile-invite-badge-v1` — instructor pending invite on Profiles
2. `admin-settings-client-visibility-review-v1` — review hiding/demoting Settings for school admins (product/packaging P1)
