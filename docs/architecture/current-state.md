...
1. `people-management-student-email-change-policy-v1` — canonical Change email flow (or `admin-settings-client-visibility-review-v1` per product priority)
